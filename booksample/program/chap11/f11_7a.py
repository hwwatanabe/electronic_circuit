...
##########################
#matplotlib.use("Agg")  #必要なときもある？
oneShotInt=int(3e-9/dt)
vtt=[]
...
plt.plot(t, vt, color="blue",
    linewidth=1.5, linestyle="-", label="$U_1(\ell, t)-U_2(\ell, t)$")    # グラフを生成
