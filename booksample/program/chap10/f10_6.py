...
def plot(data):
    ...
    plt.ylim(-10.0, 50.0)         #縦軸の最大値・最小値
    plt.grid(which="both")      #グリッドを入れる
    jikan='t=' + '%.2e'%(dt*i) + '[s]'
    plt.text(4,47.5,jikan, ha = 'left', va = 'center', fontsize=14)
...
plt.grid(which="both")      #グリッドを入れる
jikan='t=' + '%.2e'%(dt*i) + '[s]'
plt.text(0.001,1.75,jikan, ha = 'left', va = 'center', fontsize=14)
